...
<main style="padding: 0 97px" class="hea-product-cart-container">
    ...
    <section class="card hea-product-cart-posts">
        ...
        <div class="hea-product-cart-content-cost-total">
            ...
            <button class="btn hea-product-cart-button-payment submitButton" onclick="getInfo(); redirectToPage()">Thanh toán</button>
        </div>
    </section>
</main>
<script>
                            ...
                            <div class="col-md-10">
                                <div class="card-body">
                                    ...
                                    <div class="hea-product-cart-content">
                                        ...
                                        <span class="card-text hea-product-cart-totalPrice">${totalPrice}.000đ</span>
                                    </div>
                                </div>
                            </div>
                        </div>
